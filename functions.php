...
if ( ! function_exists( 'clean_setup' ) ) :
	...
	function clean_setup() {
		...
		register_nav_menus( array(
			'top-menu' => esc_html__( 'Primary', 'clean' ),
		) );
...
function clean_scripts() {
	...
	wp_enqueue_style( 'google-font-roboto', 'http://fonts.googleapis.com/css?family=Roboto:400,300,100,500' );
	wp_enqueue_style( 'google-font-roboto-slab', 'http://fonts.googleapis.com/css?family=Roboto+Slab:400,300,100,500' );
	...
	wp_enqueue_style( 'clean-main-style', get_template_directory_uri() . '/assets/css/style.css');
	...
	wp_enqueue_script( 'jquery.easing', get_template_directory_uri() . '/assets/js/jquery.easing.1.3.js', array(), '', true );
	wp_enqueue_script( 'jquery.waypoints', get_template_directory_uri() . '/assets/js/jquery.waypoints.min.js', array(), '', true );
	wp_enqueue_script( 'respond', get_template_directory_uri() . '/assets/js/respond.min.js', array(), '', true );
	wp_enqueue_script( 'clean-main', get_template_directory_uri() . '/assets/js/main.js', array(), '', true );
